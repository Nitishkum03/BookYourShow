  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        ...
        <div className='relative mt-6'>
            ...
            <video src={currentTrailer.videoUrl} className="mx-auto max-w-full" width="960" height="540" controls ={false}
        ...
        <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
            {dummyTrailers.map((trailer)=>(
                ...
                group-hover:not-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer 
